...
// Impact statistics
const impactStats = [
  { value: "500+", label: "Students Served", description: "Across local schools and community programs" },
  { value: "12", label: "School Partnerships", description: "Active collaborations with local districts" },
...
const partnerSchools = [
  { name: "Taft Middle School", program: "3D Print Lab", image: "/images/Taft-Middle-School--3D-Print-Lab-Concept.png" },
  { name: "Local Elementary Schools", program: "TinkerCAD Workshops", image: "/images/classroom-full-tinkercad-v1.png" },
  { name: "Community Centers", program: "After-School Programs", image: "/images/stem-classroom-v2.png" },
];
    ...
    <>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/images/classroom-tutoring-v1.png')" }}
        />
      ...
      <section className="relative bg-gray-50 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We partner with schools across our community to bring maker education directly to students during the school day.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {partnerSchools.map((school) => (
              <div key={school.name} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-teal-600 font-medium">{school.program}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="relative bg-gradient-to-br from-teal-600 to-teal-800 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-xl">
                <img
                  src="/images/rusteze-robotics-2025-26.png"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-xl">
                <img
                  src="/images/Taft-Middle-School--3D-Print-Lab-Concept.png"
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="aspect-square rounded-lg overflow-hidden">
              <img src="/images/classroom-full-tinkercad-v1.png" alt="Students learning TinkerCAD" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="aspect-square rounded-lg overflow-hidden">
              <img src="/images/classroom-tutoring-v1.png" alt="One-on-one tutoring" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="aspect-square rounded-lg overflow-hidden">
              <img src="/images/stem-classroom-v2.png" alt="STEM classroom" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="aspect-square rounded-lg overflow-hidden">
              <img src="/images/Taft-Middle-School--3D-Print-Lab-Concept.png" alt="3D Print Lab concept" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="aspect-square rounded-lg overflow-hidden md:col-span-2">
              <img src="/images/rusteze-robotics-2025-26.png" alt="Rusteze Robotics team" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="aspect-square rounded-lg overflow-hidden md:col-span-2">
              <img src="/images/tagline-bg-classroom.png" alt="Classroom environment" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center text-gray-600">
            <div className="flex items-center gap-2">
              ...
              <span>hello@fundedyouth.org</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
